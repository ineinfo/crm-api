...
router.put('/:id', upload.array('files'), async (req, res) => {
  ...
  try {
    ...
    const updates = { developer_name, property_type_id,  starting_price, location,  number_of_bathrooms, sqft_starting_size, owner_name, parking, furnished,  account_type, leasehold_length, formattedHandoverDate,property_business_type,user_id };
